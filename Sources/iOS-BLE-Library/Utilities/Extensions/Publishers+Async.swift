    ...
    public struct Iterator: AsyncIteratorProtocol {
        ...
        public mutating func next() async -> Element? {
            return await withTaskCancellationHandler {
                [inner] in await inner.next()
            } onCancel: {
                [inner] in inner.cancel()
            }
        }
    }
...
private extension AsyncPublisher.Iterator {
    final class Inner: Subscriber, Cancellable {
...
private extension AsyncThrowingPublisher.Iterator {
...
private extension Sequence {
    func resumeAllWithNil<Output, Failure: Error>() where Element == UnsafeContinuation<Output?, Failure> {
