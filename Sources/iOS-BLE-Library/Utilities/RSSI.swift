...
public extension RSSI {
    ...
    static let outOfRange = RSSI(integerLiteral: Const.outOfRange)
    static let practicalWorst = RSSI(integerLiteral: Const.practicalWorst)
    static let bad = RSSI(integerLiteral: Const.bad)
    static let ok = RSSI(integerLiteral: Const.ok)
    static let good = RSSI(integerLiteral: Const.good)
}
